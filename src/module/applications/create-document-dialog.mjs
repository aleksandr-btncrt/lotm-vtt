import DialogLOTM from "./api/dialog.mjs";

export default class CreateDocumentDialog extends DialogLOTM {
  /** @override */
  ...
  */
  ...
  static async promp(documentType, data = {}, { folders, types, ...createOptions } = {}, { ok = {}, ...config } = {}) {
